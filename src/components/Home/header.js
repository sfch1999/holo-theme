      ...
      <div className="max-w-7xl mx-auto lg:px-6 md:px-3">
        <div className="my-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-0 xl:mt-28 flex gap-10 lg:flex-justify lg:flex flex-col lg:flex-row flex-col-reverse">
          <div className="text-center lg:text-left flex flex-col justify-center">
            ...
            Transforming Enterprises with Tailored Artificial Intelligence Solutions
            </h1>
            ...
            <p className="mt-3 text-base text-black-70 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              ...
              Our team brings extensive expertise in machine learning, artificial intelligence, and enterprise AI solutions, backed by years of cutting-edge research and industry experience. </p>
            <p className="mt-3 text-base text-black-70 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              With a strong foundation in applied AI research, software engineering, and large-scale system development, we have successfully designed and deployed AI-driven solutions across various industries, including finance, aerospace, healthcare, and enterprise automation.
            </p>
